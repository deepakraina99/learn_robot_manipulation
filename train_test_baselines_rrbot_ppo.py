...
# R2 okay type results
# R3 not so good results
# best results with reduced learning rate of 3e-5
# not much difference with increasd speed
# with sde, running fast, but robot still not going towards left
...
save_model_dir = os.path.dirname(__file__) + "trained_models/ppo/" + "TargetReachingRRBot_taskspace_normvel_final"
...
if train:
  env = gym.make('TargetReachingRRBot-v0')
