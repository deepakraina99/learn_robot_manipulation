...
save_model_dir = os.path.dirname(__file__) + "trained_models/ddpg/" + "TargetReachingRRBot"
...
#             verbose=1)
  ...
  plot_results([log_dir], total_timesteps, results_plotter.X_TIMESTEPS, "DDPG TargetReaching RRBot")
  plt.savefig(save_model_dir + '/Rewards.png')
  plt.show()
  
if test:
  model = DDPG.load(save_model_dir + "/TargetReaching-v0")
