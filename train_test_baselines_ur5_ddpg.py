...
save_model_dir = os.path.dirname(__file__) + "trained_models/ddpg/" + "TargetReachingUR5"
...
#             verbose=1)
  ...
  plot_results([log_dir], total_timesteps, results_plotter.X_TIMESTEPS, "DDPG TargetReaching UR5")
